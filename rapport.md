...
* Vi hade viljat lägga till en Feature för: att kolla Inloggade användares features, men vi upptäckte att det inte fanns några större features för inloggade användare som inte täcktes av andra tester.
